...
- The confidential conduct record the Code requires. RATIFIED 3-rung ladder (NOT the earlier 4-rung draft): **Correction** (not a strike) → **Strike 1 — Warning** → **Strike 2 — "Board decides"** (Board convenes and, by severity, issues a time-limited suspension OR removal by two-thirds vote; a member suspended at Strike 2 who violates again is removed). Per-member strike history, status, dates, 12-month reset flagging (expired strikes marked cleared).
...
- Ties to the RATIFIED Code of Conduct (ratified 2026-08-15 by Board vote; canonical text in WCB-Code-of-Conduct-RATIFIED.md): 3-rung ladder, 7-day clock, two-thirds threshold, quorum floor 3, recusal, Ombudsman dual-role — the tool embodies that document.
